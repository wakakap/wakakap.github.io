...
//     var html = converter.makeHtml(markdownFile);
//     return html;
//   }

$(document).on('click', '.markdown-files a', function(event) {
    event.preventDefault();
    var markdownFileUrl = $(this).attr('href');
    $.get(markdownFileUrl, function(data) {
